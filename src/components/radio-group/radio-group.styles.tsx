...
export const radioGroupStyles = tv({
  slots: {
    ...
    control:
      'relative inline-flex items-center justify-center shrink-0 rounded-full border border-line bg-surface-2 data-[checked]:border-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 focus-visible:ring-offset-bg',
