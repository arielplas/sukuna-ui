...
export const breadcrumbsStyles = tv({
  slots: {
    ...
    link: 'text-text-dim hover:text-text transition-colors duration-fast ease-sukuna rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-glow',
