...
| `--sk-accent-glow` | `rgba(255,59,78,.6)` | `rgba(216,37,58,.35)` | Focus ring / glow |
| `--sk-premium` | `#E8DCC4` (bone) | `#8A7A55` | Premium / gold surfaces |
| `--sk-premium-dim` | `#B5A98C` | `#A8996F` | Premium secondary |
| `--sk-text` | `#F4F1EC` | `#141413` | Primary text |
| `--sk-text-dim` | `#9A948A` | `#5E5A52` | Secondary text |
| `--sk-text-faint` | `#6C665D` | `#8C877D` | Placeholders, disabled |
| `--sk-success` | `#31C877` | `#1E9E5A` | Done / positive |
